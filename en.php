			...
			<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a id="aboutus" class="link"><strong>About Us</strong></a>
						</li>
						<li>
							<a id="events" class="link"><strong>Events</strong></a>
						</li>
						<li>
							<a id="gallery" class="link"><strong>Gallery</strong></a>
						</li>
						<li>
							<a id="contact" class="link"><strong>Contact</strong></a>
						</li>
						<li>
						...
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><strong>EN</strong><span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a id=red href="http://fsvelicka.cz/"><strong>CZ</strong></a></li>
							</ul>
						</li>
					</ul>
				</div><!-- /.navbar-collapse -->
			...
			<div class="form-group row">
				<div class="col-lg-5 col-lg-offset-1 col-md-5 col-md-offset-1 col-sm-5 col-sm-offset-1 text-justify">
					<div class="desc">
							...
							music was not possible. Music was made by common people during both their 
							work and leisure, as well as during religious activities. The work of 
							economic production was often manual and communal. Manual labor often 
							included singing by the workers, which served several practical purposes.
							It reduced the boredom of repetitive tasks, it kept the rhythm during 
							synchronized pushes and pulls, 
				...
				<div class="col-lg-5 col-md-5 col-sm-5 text-justify">
					<div class="desc">
							...
							and it set the pace of many activities such
							as planting, weeding, reaping, threshing, weaving, and milling. In leisure
							time, singing and playing musical instruments were common forms of 
							entertainment and history-telling—even more common than today, when 
							electrically enabled technologies and widespread literacy make other 
							forms of entertainment and information-sharing competitive.
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			  <div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-target="#collapseOne">
				  <h4 class="panel-title">
					  Kuželovský fašanek
					<p class="hidden-xs pull-right">5th February 2016</p>
				  </h4>
				</div>
			  ...
			  <div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingTwo" data-toggle="collapse" data-target="#collapseTwo">
				  <h4 class="panel-title">
					  Easter Festivities
					<p class="hidden-xs pull-right">25th March 2016</p>
				  </h4>
				</div>
			  ...
			  <div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingThree" data-toggle="collapse" data-target="#collapseThree">
				  <h4 class="panel-title">
					  Horňácké slavnosti
					<p class="hidden-xs pull-right">22nd July 2016</p>
				  </h4>
				</div>
